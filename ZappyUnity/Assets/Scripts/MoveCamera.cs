...
public class MoveCamera : MonoBehaviour {
	...
	void Update () {
		...
		if (transform.position.z < -tile_z - 10)
			transform.position = new Vector3(transform.position.x, transform.position.y, height * 10 - tile_z - 10);
		if (height * 10 - tile_z - 10 < transform.position.z)
